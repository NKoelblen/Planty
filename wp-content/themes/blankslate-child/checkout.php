            ...
            <form method="post" action="<?php the_permalink(); ?>">
                <div>
                    ...
                    if ($the_query->have_posts()) :
                        while ($the_query->have_posts()) :
                            $the_query->the_post(); ?>
                            <label for="<?php echo $post->post_name . '-quantity' ?>">
                                <div style=" background: url('<?php echo wp_get_attachment_url(get_post_thumbnail_id($post->ID)); ?>')">
                                    <?php the_title(); ?>
                                </div>
                            </label>
                            <div>
                ...
                <div>
                    <div>
                        ...
                        <input type="text" id="client-surname" name="client-surname">
                    ...
                    <div>
                        ...
                        <input type="text" id="delivery-adress" name="delivery-adress">
                        <label for="delivery-postal-code">Code postal</label>
                        <input type="text" id="delivery-postal-code" name="delivery-postal-code">
